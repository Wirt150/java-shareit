...
import ru.practicum.shareit.config.validator.ValidateDateO;
...
@Data
@Builder
@ValidateDateO(message = "Дата окончания бронирования не может быть раньше даты начала бронирования.")
