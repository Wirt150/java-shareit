...
public class ItemController {
    ...
    public List<ItemDto> findAll(
        ...
        return itemService.getAllDto(userId).stream().map(ItemMapper::toItemDto).collect(Collectors.toList());
    }
    ...
    public Optional<ItemDto> findById(
        ...
        return itemService.getDtoById(id).map(ItemMapper::toItemDto);
    }
    ...
    public Optional<ItemDto> create(
        ...
        return itemService.addDto(ItemMapper.toItem(dto), userId).map(ItemMapper::toItemDto);
    }
    ...
    public Optional<ItemDto> update(
        ...
        return itemService.updateDto(ItemMapper.toItem(dto), id, userId).map(ItemMapper::toItemDto);
    }
