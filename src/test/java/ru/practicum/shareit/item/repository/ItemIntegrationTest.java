...
class ItemIntegrationTest {
    ...
    void whenCheckGetAllIdMethod() {
        ...
        //test
        List<ItemDto> itemDtos = itemController.findAll(FROM, SIZE, USER_ID_ONE);
    ...
    void whenSearchByNameAndDescription() {
        ItemDto itemDtoOne = itemController.create(itemDtoTestOne, USER_ID_ONE);
        List<ItemDto> dtosOne = itemController.search(FROM, SIZE, "TeS", USER_ID_ONE);
        ...
        ItemDto itemDtoTwo = itemController.create(itemDtoTestTwo, USER_ID_ONE);
        List<ItemDto> dtosTwo = itemController.search(FROM, SIZE, "TeS", USER_ID_ONE);
