...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> create(final ItemRequestDto dto, final long userId) {
    ...
    public ResponseEntity<Object> findAllPageable(final int from, final int size, final long userId) {
